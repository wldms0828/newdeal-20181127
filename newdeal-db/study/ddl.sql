...
CREATE TABLE nd_appl (
    ...
    reg_dt DATETIME NOT NULL COMMENT '수강신청일자', -- 수강신청일자
    stat   CHAR(1)  NULL     COMMENT '수강신청상태', -- 수강신청상태
...
CREATE TABLE nd_lesn (
    ...
    tot_hr INTEGER      NOT NULL COMMENT '총 교육시간', -- 총 교육시간
...
-- 회원
ALTER TABLE nd_memb
    ADD CONSTRAINT FK_nd_stud_TO_nd_memb -- 수강생 -> 회원
        FOREIGN KEY (
            mno -- 회원번호
        )
        REFERENCES nd_stud ( -- 수강생
