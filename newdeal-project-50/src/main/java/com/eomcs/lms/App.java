...
public class App {
  ...
  public static void main(String[] args) throws Exception {
   //AppConfig 클래스가 메모리에 로딩되어 있지 않다면, 지금 즉시 로딩한 후 그 로딩된 클래스 정보를 리턴하라
   // .class는 확장자 명이 아니다. 클래스 정보를 변경하는 것이 들어 있다.
    
    Class<?> clazz=AppConfig.class;
    /* 위의 것과 똑같은 형태 Class<?> Class<?> clazz=Class.forName("com.eomcs.lms.Appconfig");*/
