...
//웹 애플리케이션이 시작되거나 종료될 때 호출되는 메소드를 정의한 것
  ...
  public void contextInitialized(ServletContextEvent sce) {
    System.out.println("웹 어플리케이션이 시작됨!");
    ...
    iocContainer =new AnnotationConfigApplicationContext(AppConfig.class);
       ...
       System.out.println(iocContainer.getBeanDefinitionCount());
        ...
        for(String name : names) {
          ...
          //Spring IoC 컨테이너를 서블릿이 사용할 수 있도록 ServletContext라는 보관소에 저장한다.
  ...
  public void contextDestroyed(ServletContextEvent sce) {
    System.out.println("웹 어플리케이션이 종료됨!");
